...
var X = [0, 56, 96, 126, 150];         // % of card width
var Z = [0, -170, -340, -500, -660];   // px
var R = [0, 24, 32, 38, 43];           // deg
var S = [1, 0.88, 0.77, 0.68, 0.60];   // scale
var O = [1, 0.92, 0.62, 0.26, 0];      // opacity
...
var sBtns = Array.prototype.slice.call(document.querySelectorAll('[data-search-open]'));
var sModal = document.getElementById('search-modal');
if (sBtns.length && sModal) {
